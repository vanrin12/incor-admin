...
function* getDetailConstructionCustomer(action) {
  try {
    /**
     * Example data
     *
...
*/
function* getDetailConstructionCustomerSaga() {
  yield takeLatest(
    Types.GET_LIST_CONSTRUCTION_CUSTOMER,
    getDetailConstructionCustomer
  );
}

export default getDetailConstructionCustomerSaga;
